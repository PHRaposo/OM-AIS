...
(om::defmethod! normal-LINK-CHORDS ()
	:icon 013
	:doc "Returns all normal form LINK-CHORDS."
(read-text-file "normal-LINK-CHORDS"))

(om::defmethod! prime-LINK-CHORDS ()
	:icon 013
	:doc "Returns all prime form LINK-CHORDS."
(read-text-file "prime-LINK-CHORDS"))
...
(om::defmethod! all-rotations ((PCS list))
 ...
 (mapcar #'(lambda (input1)
  (om::rotate PCS input1)) (om::arithm-ser 1 (- (length PCS) 1) 1)))
